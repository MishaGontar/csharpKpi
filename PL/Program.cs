...
class Program
{
    ...
    {
        bookService.AddBook(new Book { Title = "Назва 1", Author = "Автор 1", Topic = "Тематика 1" });
        bookService.AddBook(new Book { Title = "Назва 2", Author = "Автор 2", Topic = "Тематика 1" });
        bookService.AddBook(new Book { Title = "Назва 3", Author = "Автор 2", Topic = "Тематика 2" });
        bookService.AddBook(new Book { Title = "Назва 4", Author = "Автор 3", Topic = "Тематика 3" });
